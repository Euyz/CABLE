# Overview
Using whole-brain 3D fluorescence imaging, we developed a cytoarchitecture-based link estimation (CABLE) method for accurate fiber tract mapping at cellular resolution. This method infers the fiber direction from the inherent anisotropy of the nucleus/soma shape and spatial arrangement of adjacent cells. CABLE employs the spherical deconvolution algorithm to analyze three-dimensional images of cell staining and generate the Orientation Distribution Function (ODF). This repository implements the CABLE algorithm.
# Example raw data 
